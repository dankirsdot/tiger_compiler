...
CONTROL | IGNORED | STRING | COMMENT | INITIAL
...
fun yyAction41 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; str := ""; str_pos := yypos; str_closed := false; continue()))
fun yyAction42 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (YYBEGIN INITIAL; str_closed := true; Tokens.STRING(!str, !str_pos, yypos + size(yytext)))
      end
fun yyAction43 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (str := !str ^ Option.valOf(String.fromString(yytext)); continue())
      end
...
fun yyAction45 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN STRING; control_ord := ord(String.sub(yytext, 0));
...
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN IGNORED; ignored_pos := yypos; ignored_closed := false; continue()))
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; ignored_closed := true; continue()))
fun yyAction49 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal formatting character in ignored sequence: " ^ yytext); continue())
      end
...
fun yyAction54 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; comment_pos := yypos; inc_nesting(); continue()))
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (inc_nesting(); continue()))
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      (dec_nesting(); if !nesting_level = 0 then YYBEGIN INITIAL else (); continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction53(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
              else yyAction53(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction1(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ99(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
              else yyAction53(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
              else yyAction53(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ109 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ109(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ36 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ110(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
...
fun yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ23(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyQ12(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                  else yyQ11(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"\\"
...
in
  (case (!(yyss))
   of CONTROL => yyQ0(!(yystrm), yyNO_MATCH)
    | IGNORED => yyQ1(!(yystrm), yyNO_MATCH)
